    ...
    public class App : Application
    {
        ...
        public List<Business.Contracts.Portfolio.Coin> GetCoinsStable()
        {
            if (coinList == null || coinList.Count == 0)
            {
                ...
                {
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "BTCUSDT", Price = 6500.00M, Quantity = 0.0014M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Bittrex, Pair = "BTCUSDT", Price = 5600.00M, Quantity = 0.0013M, ClosedDate = DateTime.UtcNow.AddMonths(-2) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "ETHUSDT", Price = 212.44M, Quantity = 0.55M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "XLMBTC", Price = 0.00003400M, Quantity = 175M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "XLMBTC", Price = 0.00002900M, Quantity = 224M, ClosedDate = DateTime.UtcNow.AddMonths(-2) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "NEOBTC", Price = 0.0022M, Quantity = 6.5M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Bittrex, Pair = "NEOBTC", Price = 0.0029M, Quantity = 8.0M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "POLYBTC", Price = 0.00002978M, Quantity = 500M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "POLYBTC", Price = 0.00003978M, Quantity = 175M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                    new CoinBuy { Exchange = Business.Entities.Exchange.Binance, Pair = "POLYBTC", Price = 0.0000362M, Quantity = 227M, ClosedDate = DateTime.UtcNow.AddMonths(-1) },
                };
