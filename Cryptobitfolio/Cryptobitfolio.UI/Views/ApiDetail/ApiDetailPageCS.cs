...
{
    public class ApiDetailPageCS : ContentPage
    {
        private readonly ApiViewModel _apiVM;

        public ApiDetailPageCS() : this(App.AppInstance._container.Resolve<ApiViewModel>())
        {
        }

        public ApiDetailPageCS(ApiViewModel apiVM)
        {
            this._apiVM = apiVM;
            ...
            deleteButton.Clicked += async (sender, e) =>
            {
                ...
                await _apiVM.DeleteExchangeApi(exchangeApi);
                await Application.Current.MainPage.Navigation.PopAsync();
            };
